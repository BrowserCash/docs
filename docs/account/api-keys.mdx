...
Every workspace has a root key and can create named keys under **Settings → API keys** in the [dashboard](https://app.driver.dev). All keys of a workspace share its plan, credits and concurrency limit.
