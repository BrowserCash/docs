...
Running headless browsers at scale is hard. You need to manage:

- Browser instances and resource allocation
- Proxy rotation and IP reputation
- Fingerprinting and detection evasion
- Geographic distribution

## Core Features

- **Managed Sessions** — Spin up Chrome instances on demand via API or SDK
- **CDP Access** — Connect with Playwright, Puppeteer, Selenium, or any CDP-compatible tool
- **Stealth Browsers** — Sessions run on real consumer devices, reducing detection
...
<CardGroup cols={2}>
  ...
  <Card
    title="Session API"
    href="/docs/fundamentals/creating-a-browser-session"
    icon="code"
  >
    Learn how to create and manage sessions programmatically.
  </Card>
</CardGroup>
