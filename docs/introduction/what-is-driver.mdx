---
title: "What is Driver?"
description: "Driver is a cloud platform for running managed browser sessions at scale"
---
...
const client = new BrowsercashSDK({ apiKey: process.env.DRIVER_API_KEY });
