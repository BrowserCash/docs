...
Release an address from the Network page. It stays yours until the end of the month you paid for, then leaves
the workspace and goes back to the pool; the seat drops at that point. No refund for the current month. **Keep**
on the Network page undoes a release before then. If a renewal payment fails, the addresses keep working for 2
