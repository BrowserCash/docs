...
You can find your Quickconnect URL in the [Dashboard](https://app.driver.dev). Under the "Browser API" section, click "More Options..." next to the copy button. A panel will appear to the right with your Quickconnect URL.
